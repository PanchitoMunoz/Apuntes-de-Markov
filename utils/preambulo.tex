...
\newcommand{\MarginNote}[2][]{\ifthenelse{\equal{#1}{}}{\NAM{\marginnote{#2}}}{\NAM{\marginnote{#2}[#1]}}}
...
\newcommand{\ifhlelse}[2]{% Comando auxiliar para destacar ssi \destacar está activado
\ifnum\destacar=1{\sethlcolor{#1}\hl{#2}}\else {#2}\fi}

\newcommand{\hly}[1]{% Comando para destacar en amarillo
\ifhlelse{yellow}{#1}}

\definecolor{my_lightblue}{RGB}{144,237,255}
\newcommand{\hlb}[1]{% Comando para destacar en azul claro
\ifhlelse{my_lightblue}{#1}}

\definecolor{my_orange}{RGB}{255,207,122}
\newcommand{\hlo}[1]{% Comando para destacar en naranjo
\ifhlelse{my_orange}{#1}}

\definecolor{my_green}{RGB}{122,255,107}
\newcommand{\hlg}[1]{% Comando para destacar en verde
\ifhlelse{my_green}{#1}}