...
\begin{ex}\tbf{Marcha aleatoria simple en $\zz$}\label{ex:marchaZ}
...
Una matriz $P=\big(p_{ij}\big)_{i,j\in I}$ se dice \emph{matriz estocástica} si:\\[-20pt]
\begin{itemize}
...
\begin{quote}
% \begin{mdframed}[style=st_red]
Salvo en los casos puntuales en que se indique lo contrario, todas las cadenas de Markov que aparezcan en estas notas serán consideradas implícitamente como cadenas homogéneas.
% \end{mdframed}
\end{quote}
...
\begin{defn}\tbf{Distribución inicial}
...
\begin{thm}\tbf{Existencia de una cadena de Markov con $\mu$ y $P$ dados}
...
\begin{thm}\tbf{Construcción directa de cadenas de Markov}
...
\begin{thm}\tbf{Ecuaciones de Chapman-Kolmogorov}
